...
function onInput(event) {
    ...
    (0, _fetchCountries.fetchCountries)(name).then((response)=>{
...
function creatCountryInfo(element) {
    return element.map(({ flags , name , capital , population , languages  })=>`
...
function drawOnPage(refs1, markup) {
    refs1.innerHTML = markup;
}

},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","./fetchCountries":"fTQqv","notiflix/build/notiflix-notify-aio":"eXQLZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
